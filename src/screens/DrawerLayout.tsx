...
const DrawerLayout = () => {
  ...
  return (
    ...
    <Drawer.Navigator initialRouteName="tab"
      ...
      <Drawer.Screen name="home" component={HomeScreen} options={{ headerTintColor:'black',headerStyle:{backgroundColor: 'white',elevation:10, borderBottomColor:'white',borderBottomWidth:2, height:75},title: 'Accueil', headerTitle: () => <Image style={{ height: 80, width: 80 }} source={require('../assets/logo.png')} />, drawerIcon: ({ focused, size }) => (<Icon color={focused ? colors.mainColor : 'gray'} name="home" size={size} />) }} />
